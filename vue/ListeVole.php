...
<table>
    ...
    <?php foreach ($seances as $seance): ?>
        <tr>
            <td><?= htmlspecialchars($seance['id_vole']) ?></td>
            <td><?= htmlspecialchars($seance['date_vole']) ?></td>
            <td><?= htmlspecialchars($seance['heure_vole']) ?></td>
            <td><?= htmlspecialchars($seance['ville_arr']) ?></td>
            <td><?= htmlspecialchars($seance['ville_dep']) ?></td>
            <td><?= htmlspecialchars($seance['ref_avion']) ?></td>
            <td><?= htmlspecialchars($seance['ref_compagnie']) ?></td>
        </tr>
    <?php endforeach; ?>
</table>
